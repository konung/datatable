...
describe "ruby_aoColumn" do
  ...
  describe "using raw sql" do
    ...
    it 'should return nil for all columns when no properties are set' do
      ...
      helper.send(:ruby_aocolumn)[0].should be_nil
      helper.send(:ruby_aocolumn)[1].should be_nil
    end
    ...
    it 'should support asSorting' do
      ...
      helper.send(:ruby_aocolumn)[0]['asSorting'].should == 'asc'
      helper.send(:ruby_aocolumn)[1]['asSorting'].should == 'desc'
    end
    ...
    it 'should support bSearchable' do
      ...
      helper.send(:ruby_aocolumn)[0]['bSearchable'].should == true
      helper.send(:ruby_aocolumn)[1]['bSearchable'].should == false
    end
    ...
    it 'should support bSortable' do
      ...
      helper.send(:ruby_aocolumn)[0]['bSortable'].should == true
      helper.send(:ruby_aocolumn)[1]['bSortable'].should == false
    end
    ...
    it 'should support bUseRendered' do
      ...
      helper.send(:ruby_aocolumn)[0]['bUseRendered'].should == true
      helper.send(:ruby_aocolumn)[1]['bUseRendered'].should == false
    end
    ...
    it 'should support bVisible' do
      ...
      helper.send(:ruby_aocolumn)[0]['bVisible'].should_not be_nil
      helper.send(:ruby_aocolumn)[0]['bVisible'].should be_false
      helper.send(:ruby_aocolumn)[1].should be_nil
    end
    ...
    it 'should support fnRender' do
      ...
      helper.send(:ruby_aocolumn)[0]['fnRender'].should == "function(oObj){'foo'}"
      helper.send(:ruby_aocolumn)[1]['fnRender'].should == "function(oObj){'bar'}"
    end
    ...
    it 'should support iDataSort' do
      ...
      helper.send(:ruby_aocolumn)[0]['iDataSort'].should == 1
      helper.send(:ruby_aocolumn)[1]['iDataSort'].should == 0
    end
    ...
    it 'should support sClass' do
      ...
      helper.send(:ruby_aocolumn)[0]['sClass'].should == 'foo'
      helper.send(:ruby_aocolumn)[1]['sClass'].should == 'bar'
    end
    ...
    it 'should support sDefaultContent' do
      ...
      helper.send(:ruby_aocolumn)[0]['sDefaultContent'].should == 'foo'
      helper.send(:ruby_aocolumn)[1]['sDefaultContent'].should == 'bar'
    end
    ...
    it 'should support sName' do
      ...
      helper.send(:ruby_aocolumn)[0]['sName'].should == 'foo'
      helper.send(:ruby_aocolumn)[1]['sName'].should == 'bar'
    end
    ...
    it 'should support sTitle' do
      ...
      helper.send(:ruby_aocolumn)[0]['sTitle'].should == 'foo'
      helper.send(:ruby_aocolumn)[1]['sTitle'].should == 'bar'
    end
    ...
    it 'should support sType' do
      ...
      helper.send(:ruby_aocolumn)[0]['sType'].should == 'string'
      helper.send(:ruby_aocolumn)[1]['sType'].should == 'numeric'
    end
    ...
    it 'should support sWidth' do
      ...
      helper.send(:ruby_aocolumn)[0]['sWidth'].should == '42px'
      helper.send(:ruby_aocolumn)[1]['sWidth'].should == '42%'
    end
